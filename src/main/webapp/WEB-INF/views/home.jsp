...
<body>
	...
	<shiro:guest>
		...
		<p>We would love to make you a more permanent part of the family. </p>
		<p>How about <a href="identity/registration">Registering</a> ? Then, you could read the <a href="docs">Docs</a></p>
		<p>Or if you have an account, please <a href="identity/login">Login</a></p>
	</shiro:guest>
	...
	<shiro:user>
		<shiro:authenticated>
			...
			<p>You could <a href="identity/logout">Logout</a> now.</p>
		</shiro:authenticated>
		...
		<shiro:hasRole name="Test">
			<h2>Test Role</h2>
			<p>Whoot! You actually have a role, even if it is just a testrole.</p>
		</shiro:hasRole>
